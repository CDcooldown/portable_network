...
struct MD5Sum< ::dmsgs::TeamInfo_<ContainerAllocator> >
{
  ...
  {
    return "9923f0b731d645e24be75b637ec9bb7a";
  }

  static const char* value(const ::dmsgs::TeamInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9923f0b731d645e2ULL;
  static const uint64_t static_value2 = 0x4be75b637ec9bb7aULL;
};
